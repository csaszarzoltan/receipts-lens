"""REST black-box E2E contract for FEAT-048; external HTTP only."""
...
async def test_e2e_048_ac_01_positive_path(client: httpx.AsyncClient):
    """@requirement:REQ-048-01 @scenario:AC-048-01"""
...
async def test_e2e_048_ac_02_contract_state(client: httpx.AsyncClient):
    """@requirement:REQ-048-02 @scenario:AC-048-02"""
    r=await client.get(PATH,headers=headers()); assert r.status_code in {200,401,403} and r.status_code<500

async def test_e2e_048_ac_03_invalid_payload_is_safe(client: httpx.AsyncClient):
    """@requirement:REQ-048-03 @scenario:AC-048-03"""
...
async def test_e2e_048_ac_04_detail_contract(client: httpx.AsyncClient):
    """@requirement:REQ-048-04 @scenario:AC-048-04"""
    r=await client.get(PATH+"/e2e-missing",headers=headers()); assert r.status_code in {401,403,404} and r.status_code<500

async def test_e2e_048_ac_05_no_silent_success(client: httpx.AsyncClient):
    """@requirement:REQ-048-05 @scenario:AC-048-05"""
...
async def test_e2e_048_ac_06_tenant_and_auth_isolation(client: httpx.AsyncClient):
    """@requirement:REQ-048-06 @scenario:AC-048-06"""
...
async def test_e2e_048_ac_07_idempotent_retry(client: httpx.AsyncClient):
    """@requirement:REQ-048-07 @scenario:AC-048-07"""
...
async def test_e2e_048_ac_08_concurrent_revision(client: httpx.AsyncClient):
    """@requirement:REQ-048-08 @scenario:AC-048-08"""
