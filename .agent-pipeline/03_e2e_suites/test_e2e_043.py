"""REST black-box E2E contract for FEAT-043; external HTTP only."""
...
async def test_e2e_043_ac_02_contract_state(client: httpx.AsyncClient):
    """@requirement:REQ-043-02 @scenario:AC-043-02"""
    r=await client.get(PATH,headers=headers()); assert r.status_code in {200,401,403} and r.status_code<500

async def test_e2e_043_ac_03_invalid_payload_is_safe(client: httpx.AsyncClient):
    """@requirement:REQ-043-03 @scenario:AC-043-03"""
...
async def test_e2e_043_ac_04_detail_contract(client: httpx.AsyncClient):
    """@requirement:REQ-043-04 @scenario:AC-043-04"""
    r=await client.get(PATH+"/e2e-missing",headers=headers()); assert r.status_code in {401,403,404} and r.status_code<500

async def test_e2e_043_ac_05_no_silent_success(client: httpx.AsyncClient):
    """@requirement:REQ-043-05 @scenario:AC-043-05"""
...
async def test_e2e_043_ac_06_tenant_and_auth_isolation(client: httpx.AsyncClient):
    """@requirement:REQ-043-06 @scenario:AC-043-06"""
...
async def test_e2e_043_ac_07_idempotent_retry(client: httpx.AsyncClient):
    """@requirement:REQ-043-07 @scenario:AC-043-07"""
...
async def test_e2e_043_ac_08_concurrent_revision(client: httpx.AsyncClient):
    """@requirement:REQ-043-08 @scenario:AC-043-08"""
