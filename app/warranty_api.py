"""FastAPI adapter for FEAT-040."""
from __future__ import annotations
import uuid
from fastapi import APIRouter,Header,HTTPException,Response
from fastapi.responses import JSONResponse
from app.warranty_models import CreateRequest,CommandRequest,DomainError
from app.warranty_service import service
router=APIRouter(prefix="/api/v2/warranties",tags=["FEAT-040"])
