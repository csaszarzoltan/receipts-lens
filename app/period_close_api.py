"""FastAPI adapter for FEAT-047."""
from __future__ import annotations
import uuid
from fastapi import APIRouter,Header,HTTPException,Response
from fastapi.responses import JSONResponse
from app.period_close_models import CreateRequest,CommandRequest,DomainError
from app.period_close_service import service
router=APIRouter(prefix="/api/v2/accounting-periods",tags=["FEAT-047"])
