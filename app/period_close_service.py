"""Tenant-isolated, idempotent service for FEAT-047."""
from __future__ import annotations
from datetime import UTC,datetime
import hashlib,json,threading,uuid
from app.period_close_models import AccountingPeriod,CreateRequest,CommandRequest,Status,NotFoundError,StaleRevisionError,IdempotencyConflictError
...
class AccountingPeriodService:
    ...
    def create(self,tenant_id:str,key:str,request:CreateRequest):
        ...
        with self._lock:
            ...
            item=AccountingPeriod(id=uuid.uuid4().hex,tenant_id=tenant_id,status=Status.OPEN,revision=0,client_reference=request.client_reference,data=request.payload,evidence={"source":"FEAT-047"})
    ...
    def command(self,tenant_id:str,item_id:str,key:str,request:CommandRequest):
        ...
        with self._lock:
            ...
            target={"confirm":"REOPENED","reject":"RECLOSED","resolve":"REOPENED","reopen":"OPEN"}.get(request.action,item.status.value)
