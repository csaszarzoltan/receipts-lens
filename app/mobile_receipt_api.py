"""FastAPI adapter for FEAT-048."""
from __future__ import annotations
import uuid
from fastapi import APIRouter,Header,HTTPException,Response
from fastapi.responses import JSONResponse
from app.mobile_receipt_models import CreateRequest,CommandRequest,DomainError
from app.mobile_receipt_service import service
router=APIRouter(prefix="/api/v2/mobile-receipts",tags=["FEAT-048"])
