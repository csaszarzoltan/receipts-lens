"""FastAPI adapter for FEAT-044."""
from __future__ import annotations
import uuid
from fastapi import APIRouter,Header,HTTPException,Response
from fastapi.responses import JSONResponse
from app.savings_models import CreateRequest,CommandRequest,DomainError
from app.savings_service import service
router=APIRouter(prefix="/api/v2/savings-goals",tags=["FEAT-044"])
